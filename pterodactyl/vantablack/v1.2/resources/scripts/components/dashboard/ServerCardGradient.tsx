...
export default ({ server }: { server: Server }) => {
    ...
    return (
        ...
        <div className={styles.server_card}>
            <div className={`${styles.server_card_visual} bg-center bg-cover bg-no-repeat relative px-6 pt-5 z-10`} css={`background-image:url(${server.eggImage ? server.eggImage : '/vantablack/minecraft-banner.png'})`}>
                <div className={`${styles.server_card_overlay} z-[-1] absolute inset-0`} css={'background-image:linear-gradient(0deg, var(--gray700-default) 0%, color-mix(in srgb, var(--gray700-default) 65%, transparent) 100%);'}/>
                ...
                <div className={`${styles.server_card_metrics} grid lg:grid-cols-2 gap-2 mt-4`}>
