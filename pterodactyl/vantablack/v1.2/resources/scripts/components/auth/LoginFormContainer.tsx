                ...
                <div className={`max-w-[450px] w-screen lg:p-6 p-5 ${loginLayout == 1 ? 'bg-gray-700 rounded-box' : ''}`}>
                    ...
                    {socialPosition == 2 &&
                        <div className={'flex justify-center gap-x-6 mt-5'}>
                            {discord && discord !== 'none' && <a className={'flex gap-x-1 items-center duration-300 hover:text-gray-100'} href={guildData?.instant_invite || support || 'https://discord.gg/2vx6tCXmr4'} target={'_blank'} rel={'noopener noreferrer'}><FaDiscord /> Discord</a>}
